...
infoApp1.controller('connectionCtrl', function ($scope, $location, $http, $routeParams, moment, 
	...
	getString='&fields[]=connections/from/departureTimestamp&fields[]=connections/from/departure&fields[]=connections/from/station/name&fields[]=connections/from/platform&fields[]=connections/duration&fields[]=connections/to/arrivalTimestamp&fields[]=connections/to/platform&fields[]=connections/to/arrival&fields[]=connections/sections/journey/name&fields[]=connections/sections/journey/category&fields[]=connections/sections/journey/operator&fields[]=connections/sections/journey/number&fields[]=connections/sections/departure/station/name&fields[]=connections/sections/departure/departure&fields[]=connections/sections/departure/platform&fields[]=connections/sections/departure/departureTimestamp&fields[]=connections/sections/arrival/platform&fields[]=connections/sections/arrival/station/name&fields[]=connections/sections/arrival/arrival&fields[]=connections/sections/arrival/arrivalTimestamp';
	var url = 'https://transport.opendata.ch/v1/connections?from=' + $scope.fromStation + '&to=' + $scope.toStation + getString;
	...
	$scope.reverseConnection = function () {
		url = 'https://transport.opendata.ch/v1/connections?from=' + $scope.toStation + '&to=' + $scope.fromStation + getString;
